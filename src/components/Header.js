    ...
    <>
      <header className="header-top-strip py-3">
        <div className="container">
          <div className="row ">
            <div className="col-6">
              <p className='text-white mb-0'>This is me, Su_priya</p>
            </div>

            <div className="col-6">
              <p className='text-end text-white mb-0'>HelpLine : <a href='tel:+2314555447'>2314555447</a></p>
            </div>
      ...
      <header className="header-upper py-3">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-5">
            <header className="header-upper-links d-flex align-item-center justify-content-between">
                <div>

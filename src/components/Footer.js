        ...
        <div className="col-4">
          ...
          <div className='footer-links d-flex flex-column'>
            <address className='text-white fs-5'>
              Hno: 277 Maar Vill chapal,<br/>
              Saint, Hariyana <br/> Pincode: 131103
            </address>
            <a href="tel:+91 5212356891" className="mt-2 d-block mb-1 text-white">
            +91 5212356891</a>
            <a href="mailto:contact@gmail.com" className="mt-2 d-block mb-0 text-white">
           contact@gmail.com</a>
